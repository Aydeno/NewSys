...
function cityselect(str) {
	$("#sel2 option[value='"+str+"']").attr("selected",true);
	change(2);
}
function townselect(str) {
	$("#sel3 option[value='"+str+"']").attr("selected",true);
}
...
function promptinfo(sids){
    var sel1 = $("#sel1");
    var sel2 = $("#sel2");
    var sel3 = $("#sel3");
	$("#address").attr("value",sel1.val()+sel2.val()+sel3.val());
